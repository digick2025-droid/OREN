...
const fr = {
  ...
  login_sub: "Connectez-vous à votre espace OREN",
  ...
  signup_sub: "Rejoignez OREN Pro en quelques secondes",
  signup_full_name: "Nom complet",
  signup_confirm_password: "Confirmer le mot de passe",
  signup_password_hint: "8 caractères minimum, avec au moins une lettre et un chiffre.",
  signup_btn: "Créer mon compte",
  signup_creating: "Création…",
  signup_ok: "Compte créé avec succès",
  signup_have_account: "Déjà un compte ?",
  signup_need_name: "Entrez votre nom complet",
  signup_password_mismatch: "Les mots de passe ne correspondent pas",
  signup_confirm_title: "Vérifiez votre email",
  signup_confirm_sub: "Un lien de confirmation a été envoyé à",
  auth_reset_title: "Mot de passe oublié",
  auth_reset_sub: "Entrez votre email pour recevoir un lien de réinitialisation.",
  auth_reset_sent_sub: "Si un compte existe avec cet email, un lien vous a été envoyé.",
  auth_reset_btn: "Envoyer le lien",
  auth_reset_sending: "Envoi…",
  auth_reset_sent: "Email envoyé",
  auth_reset_ok: "Mot de passe mis à jour",
  auth_new_password_title: "Nouveau mot de passe",
  auth_new_password_sub: "Choisissez un nouveau mot de passe sécurisé.",
  auth_new_password: "Nouveau mot de passe",
  auth_new_password_btn: "Enregistrer",
  ...
  auth_error_weak_password: "Mot de passe trop faible (8 caractères, lettre et chiffre)",
  auth_error_not_found: "Aucun compte associé à cet email",
  ...
  promo_placeholder: "Entrez un code",
  promo_apply: "Appliquer",
  promo_checking: "Vérification…",
  promo_remove: "Retirer",
  promo_applied_prefix: "Code appliqué",
  promo_invalid_default: "Ce code promo n'est pas valide.",
...
const en: Dict = {
  ...
  auth_error_weak_password: "Password too weak (8 chars, letter and number)",
  auth_error_not_found: "No account found for this email",
  ...
  promo_remove: "Remove",
  promo_applied_prefix: "Code applied",
  promo_invalid_default: "This promo code is not valid.",
