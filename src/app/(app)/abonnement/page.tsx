...
export default function AbonnementPage() {
  ...
  return (
    <div>
      <ScreenHeader title="Abonnement" backHref="/reglages" />
      <div className="space-y-4 px-4 pt-4">
            ...
            {usage.quota !== null &&
              ...
              usage.used >= usage.quota && (
                <Card className="border-coral/40 bg-[#FFF3F2] p-4 text-[13.5px] text-navy">
                  <span className="font-bold">Limite atteinte.</span> Passez à
                  une offre supérieure pour continuer à créer des documents.
                </Card>
              )}
          </>
        )}
        ...
        <Button asChild className="w-full">
          <Link href="/offres">Changer d&apos;offre</Link>
        </Button>
      </div>
    </div>
  );
